...
typedef struct
{
        ...
        JUDASSAMPLE *volatile smp;        /* Pointer to sample currently used */
 ...
 */
JUDASSAMPLE *judas_allocsample(int length);
void judas_ipcorrect(JUDASSAMPLE *smp);
void judas_freesample(JUDASSAMPLE *smp);
void judas_playsample(JUDASSAMPLE *smp, unsigned chnum, unsigned frequency, unsigned short volume, unsigned char panning);
 ...
 */
JUDASSAMPLE *judas_loadrawsample(char *name, int repeat, int end, unsigned char voicemode);
JUDASSAMPLE *judas_loadwav(char *name);
