...
l_bool AppEventHandler ( PWidget o, PEvent Ev )
{
	if ( Ev->Type == EV_MESSAGE )
	{
		...
		if ( Ev->Message == MSG_COLNO ) NoFlame();
...
l_int Main ( int argc, l_text *argv )
{
	...
	PMenu Menu = NewMenu(
     ...
     NewMenuItem( "View", NULL, NULL, NULL, 
 		NewMenu (
     		 		NewMenuItem( "No Effect",  NULL, MSG_COLNO, NULL, NULL,
     		 		NewMenuItem( "Normal Fire", NULL, MSG_COLRED, NULL, NULL,
     		 		NewMenuItem( "Blue Fire", NULL, MSG_COLBLUE, NULL, NULL,
     		 		NewMenuItem( "Green Fire", NULL, MSG_COLGREEN, NULL, NULL, NULL))))
     		 ),
