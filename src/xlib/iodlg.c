...
l_text IOBox ( l_text Title, l_ulong Flags, l_text *Dir, PFileTypes Types, l_bool FExists )
{
        ...
        l->AddItem(l, "Computer", "/", Icon);	
        l->AddSeperator(l);
        l->AddItem(l, "Home", "/system/User/", Icon);
        l->AddItem(l, "Desktop", "/system/User/Desktop/", Icon);	
        l->AddItem(l, "Pictures", "/system/User/Pictures/", Icon);
        l->AddItem(l, "Music", "/system/User/Music/", Icon);
        l->AddItem(l, "Documents", "/system/User/Documents/", Icon);
