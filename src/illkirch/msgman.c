...
void MsgMan( void ) {
        ...
        l = CreateLabel(&Me,r,"Description :");
        InsertWidget(WIDGET(w), WIDGET(l));
        ...
        RectAssign(&r, 300, r.b.y+10, 400, r.b.y+30);
        ...
        do {
                ...
                if ( Msg == MSG_REMOVE ) {
                        ...
                        if ( Current ) ListviewItemRemoveItem(t, Current);
                        ...
                        if ( Current ) {
                                ...
                                if ( TextNCompare("MSG_",iName->Text,4) ) {
                                        Name = TextArgs("MSG_%s",iName->Text);
                                } else
                        ...
                        if ( Msg == MSG_NEWSUB ) {
                                ...
                                Name = TextArgs("MSG_MSG%d",MessageCount);
                                Message = TextArgs("%x",0x00010000 + MessageCount);

                                n = ListviewAddItem(t,Name,NULL);
                                if ( n ) {
                                        ListviewItemPushCol(n,Message);
                                        ListviewItemPushCol(n,"Simple message");
                                }
                                ListviewUpdateScrollbars(t);
                                WidgetDraw(WIDGET(t),NULL);
